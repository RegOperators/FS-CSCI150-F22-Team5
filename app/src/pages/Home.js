        ...
        <div className="container mx-auto px-6 sm:px-12">
          <section className="mb-32">
            <div className="max-w-5xl mx-auto flex flex-col items-center mb-16">
              <h1 className="text-3xl xl:text-5xl 2xl:text-6xl font-bold text-center mb-8">Classes are hard enough, signing up for them shouldn't be</h1>
              <p className="text-gray-500 sm:text-lg text-center mb-8">RegOp is designed to make the process of class enrollment easier. Our goal is a one stop shop to the perfect day-to-day schedule.</p>
              <Link className="bg-indigo-500 hover:bg-indigo-400 text-white text-lg font-semibold px-4 py-2.5 rounded-md" to="/schedule-generator">Get started</Link>
            </div>
            <img className="w-full drop-shadow-2xl" src={browserMockupLight} alt="Browser Mockup" />
          </section>
